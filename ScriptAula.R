...
tail(cartao) #6 ?ltimas linhas 

#subsetting de posi??o
cartao[,2]
cartao[2,]

#subsetting por nome de vari?vel
cartao$Impostos[2]
...
summary(cartao)#m?tricas descritivas
...
#matriz de correla??o sem coluna de segmento
cor(cartao[,1:4])
...
lista[[1]][2]#selecionar posi??o 2 da lista n?meros
lista$numeros[,2] #selecionar posi??o 2 da lista n?meros
...
#4 realizar um gr?fico de dispers?o utilizando as vari?veis Impostos por gasto no cart?o para categoria C
